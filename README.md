...
```
cd ~/Desktop && curl -O -L https://github.com/mattcarlotta/ssdtGenApp/raw/master/ssdtGen.zip
```
Unzip the ssdtGen.zip file and double click the sddtGen.app to run it (does NOT need to be installed in the Applications folder)

Go here for more support: <a href="http://www.insanelymac.com/forum/topic/322811-ssdtgen-script-for-custom-generated-ssdts-x99z170-systems/#entry2403977">ssdtGen for custom generated SSDTs (x99/z170 systems)</a>
